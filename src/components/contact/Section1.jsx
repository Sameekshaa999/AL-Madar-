  ...
  return (
    <div className="pt-24 font-Montserrat text-mpurple font-normal ">
      <div className="contact-gradient1 pt-10 py-5 text-center text-white">
        ...
        <div className="flex justify-around space-x-10 items-center my-10 mx-14">
          <div className="">
            <h1 className="text-sm font-bold mb-4 md:text-xl">Existing Tenants</h1>
          ...
          <div className="">
            <h1 className="text-sm font-bold mb-4 md:text-xl">Prospective Residents</h1>
            <p className="text-xs md:text-base">
          ...
          <div className="">
            <h1 className="text-sm font-bold mb-4 md:text-xl">Existing Clients/Owners</h1>
            <p className="text-xs md:text-base">
      ...
      <div className="my-10">
        <div className="flex space-between justify-center my-5 md:my-10">
          ...
          <p className="pt-3 text-sm md:text-lg font-Montserrat text-mpurple font-semibold">    New Clients (Property Owners)</p>
        </div>
        <div className="">
          ...
          <img src={contactArrow} alt="contactArrow" className="h-10 md:h-16 m-auto" />
        </div>
      </div>
    </div>
  );
