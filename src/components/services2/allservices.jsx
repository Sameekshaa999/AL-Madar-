  ...
  return (
    <div className="max-w-[1200px] pt-24 font-montserrat text-mpurple px-4  mx-auto">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col lg:flex-row justify-center items-center lg:space-x-32 my-5 lg:my-10">
        ...
        <div className="flex flex-col-reverse lg:flex-row justify-center items-center lg:space-x-20 my-5 lg:my-10">
          <div className="flex flex-col space-y-5">
            <h1 className="font-bold text-2xl">
              Facility <span className="text-mblue">Management</span>
            </h1>
            <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-16">
              <ul className="flex flex-col space-y-2 text-sm md:text-base">
                <li className="flex space-x-2">
