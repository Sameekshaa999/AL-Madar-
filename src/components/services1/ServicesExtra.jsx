...
const ServicesExtra = () => {
  return (
    <div className="2xl:max-w-[1200px] 2xl:mx-auto flex flex-col md:flex-row md:space-x-32 md:justify-center font-montserrat text-mpurple font-normal m-auto my-7 md:my-20 bg-white">
      <Zoom>
