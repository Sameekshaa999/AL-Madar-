...
const ServicesSection1 = () => {
  return (
    <div className="overflow-x-hidden 2xl:max-w-[1440px] 2xl:mx-auto pt-24 relative w-full flex flex-col justify-center font-montserrat text-mpurple ">
      <img src={services1_bg} alt="services1_bg" className="top-6.5 h-36 md:h-auto w-auto" />
