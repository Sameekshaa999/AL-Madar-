...
const About = () => {
  ...
  return (
    <div className=" flex flex-col-reverse lg:flex-row justify-center items-center px-10 py-10 lg:space-x-40  about-gradient">
      <Fade left ><div className="lg:ml-20 text-white font-montserrat">
      ...
      <Fade right><img src={hexagons} alt="hexagons" className="md:w-2/5 mt-10"/></Fade>
    </div>
