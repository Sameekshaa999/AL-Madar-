...
const About = () => {
  return (
    <div className="snap-align-none lg:snap-start flex flex-col-reverse lg:flex-row justify-center items-center px-10 py-10 lg:space-x-40 pt-24 about-gradient">
      <Fade top duration={2000}><div className="lg:ml-20 text-white font-montserrat">
      ...
      <Fade bottom duration={2000}><img src={hexagons} alt="hexagons" className="md:w-2/5 mt-10"/></Fade>
    </div>
  );
};
