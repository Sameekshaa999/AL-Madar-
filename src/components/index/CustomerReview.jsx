...
const CustomerReview = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row font-montserrat text-white justify-center items-center bg-s relative ">
    <div className="customer-review-gradient parallelogram w-96 md:w-1/2 py-40 md:py-72 "></div>
      <div className="absolute w-96 md:w-1/2 mt-32 md:left-2">
        <Swiper
          spaceBetween={30}
        ...
        >
          <SwiperSlide id="client 1">
            <div className="flex flex-col justify-center items-center space-y-3 md:space-y-10">
              ...
              <p className="w-3/4 inline-block text-center text-sm md:text-lg">
      ...
      <div className="md:w-1/2 md:float-right flex flex-row-reverse md:flex-col space-x-28 md:space-y-20 justify-center items-center">
        <img src={stars} alt="review" className=" w-1/2 md:w-2/6 md:absolute right-0 top-2" />
        <h1 className="mx-auto ml-20 font-bold text-2xl md:text-6xl text-mpurple tracking-[.1em]">
          Customer <br />
