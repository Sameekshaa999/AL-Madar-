...
const Properties = () => {
  return (
    <div className="2xl:max-w-[1200px] 2xl:mx-auto flex flex-col justify-center items-center space-y-5 font-montserrat text-mpurple mx-4 lg:mx-40 my-10">
      ...
      <div className="flex flex-row lg:flex-col">
          ...
          <div className="order-1 lg:order-2 basis-1/3 grid grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-2">
            <Slide left><img src={qatar2} alt="qatar property 2" className="p-0.5 md:p-1" /></Slide>
        ...
        <div className="flex flex-row lg:flex-col">
          ...
          <div className="order-2 lg:order-1 basis-1/3 grid grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-2">
            ...
            <Slide right><img src={dubai2} alt="dubai property 1" className="p-0.5 md:p-1" /></Slide>
          </div>
        </div>
