...
const Properties = () => {
  return (
    <div className="2xl:max-w-[1440px] 2xl:mx-auto overflow-x-hidden flex flex-col justify-center items-center space-y-5 font-montserrat text-mpurple mx-4 lg:mx-40 my-10">
