...
const Properties = () => {
  return (
    <div className="flex flex-col justify-center items-center space-y-5 font-montserrat text-mpurple mx-20 md:mx-40 my-10">
      ...
      <div className="flex flex-row md:flex-col">
          <div className="order-2 md:order-1 basis-2/3 p-2 md:p-0 px-6 md:px-0 overflow-clip">
            <img
              src={qatar1}
              alt="qatar property 1"
              className="md:p-1 h-full scale-y-105 scale-x-125 md:transform-none "
            />
          </div>
        ...
        <div className="flex flex-row md:flex-col">
          <div className="order-1 md:order-2 basis-2/3 p-2 md:p-0 px-6 md:px-0 overflow-clip">
            <img
              src={dubai1}
