...
const Services = () => {
  return (
    ...
    //   <div className="serviceSection-gradient flex flex-col justify-center items-left  ">
    //     <div className="flex-col text-mpurple text-right   relative font-montserrat ">
    ...
    //   </div>
    //   <div className=" ">
    //     <img src={map} alt="mv3" className="h-1/2" />
    //   </div>
    // </div>
