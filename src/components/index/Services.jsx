...
const Services = () => {
  return (
    <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row justify-center items-center space-x-10 my-3 lg:my-10">
      <div className="serviceSection-gradient flex flex-col justify-center items-left h-1/2 w-1/2 py-20 lg:py-40 px-2 pb-54 ">
        <Fade left cascade>
        <div className="flex-col text-mpurple text-center lg:text-right space-y-5 lg:space-y-12 relative font-montserrat ">
          ...
          <p className="lg:mt-4 text-sm font-light lg:text-lg lg:leading-relaxed inline-block lg:ml-40 ml-0 text-white">
